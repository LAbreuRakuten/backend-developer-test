...
namespace Rakuten.Test.Web.UserService {
    ...
    public interface UserSoap {
        ...
        // CODEGEN: Gerando contrato de mensagem porque o nome do elemento GetUserResult no namespace http://tempuri.org/ não está marcado como nulo
        ...
        // CODEGEN: Gerando contrato de mensagem porque o nome do elemento GetUsersResult no namespace http://tempuri.org/ não está marcado como nulo
        ...
        // CODEGEN: Gerando contrato de mensagem porque o nome do elemento user no namespace http://tempuri.org/ não está marcado como nulo
        ...
        // CODEGEN: Gerando contrato de mensagem porque o nome do elemento DeleteUserResult no namespace http://tempuri.org/ não está marcado como nulo
        ...
        // CODEGEN: Gerando contrato de mensagem porque o nome do elemento documentId no namespace http://tempuri.org/ não está marcado como nulo
        ...
        // CODEGEN: Gerando contrato de mensagem porque o nome do elemento rg no namespace http://tempuri.org/ não está marcado como nulo
